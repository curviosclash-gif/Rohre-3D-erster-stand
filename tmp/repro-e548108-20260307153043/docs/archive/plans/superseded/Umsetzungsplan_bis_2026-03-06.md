...
- [x] V6 Menue-Schnellpresets einfuehren (abgeschlossen 2026-03-06)
  ...
  - Erweiterter Referenzplan (inkl. Menue-Umbau/Multiplayer-Stub/Developer-Modus): `docs/archive/plans/completed/Feature_Menu_Umbau_V26_3.md`.
...
- [ ] V11 Mehr Map-Varianz ueber GLB/GLTF-Maps
  ...
  - Referenz: `docs/archive/plans/superseded/Feature_GLB_Map_Loader.md`.
...
- [ ] V24 Performance-Flaschenhaelse systematisch abbauen
  ...
  - Referenzplan: `docs/archive/plans/completed/Feature_Performance_Flaschenhaelse_Abarbeitung.md`.
- [x] V25 Weitere Modularisierung ausserhalb Phase 24 (abgeschlossen 2026-03-05)
  ...
  - Referenzplan: `docs/archive/plans/completed/Feature_Modularisierung_V25_Ausserhalb_Phase24.md`.
...
- [x] 26.3 V6 Menue-Umbau (modular, Multiplayer-ready, Developer-Modus) (abgeschlossen 2026-03-06)
  - Referenzplan: `docs/archive/plans/completed/Feature_Menu_Umbau_V26_3.md`.
...
- [x] 26.3b Menu-Ebenen-Follow-up (abgeschlossen, Stand 2026-03-06)
  - Referenzplan: `docs/archive/plans/completed/Feature_Menu_Ebenen_Followup_V26_3b.md`.
...
- [x] 26.7 Cinematic Kamera & Auto-Recording Pipeline vorbereiten (Teil von V29) (abgeschlossen 2026-03-05)
  - Referenzplan: `docs/archive/plans/completed/Feature_Cinematic_Camera_V29.md`.
