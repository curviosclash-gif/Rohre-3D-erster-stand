...
- `test:contract` nutzt seit `V112.6.1` den Node-Test-Glob `tests/*.contract.test.mjs`; neue `*.contract.test.mjs`-Dateien sind damit ohne Skriptlistenpflege abgedeckt. Die historischen Nicht-Contract-Zusatzchecks bleiben explizit im Skript genannt.
