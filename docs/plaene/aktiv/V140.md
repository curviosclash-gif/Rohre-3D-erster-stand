...
- [ ] 140.4.4 Mobile-Contracts und Android-Asset-Check ausfuehren; `MobileClassicApp.js`-Ceiling nach jedem sicheren Schnitt senken oder entfernen. (Teil-Evidence 2026-06-08: Style-Slice -> Mobile-Contracts 29/29 PASS, `app:android:assets:check` PASS, Ceiling 1180 -> 706; Update-Slice -> Mobile-Contracts 29/29 PASS, `app:android:assets:check` PASS, Ceiling 706 -> 548; Menu-Slice bleibt offen.)
