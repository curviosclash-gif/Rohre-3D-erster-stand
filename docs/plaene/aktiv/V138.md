...
- [x] DoD.1 `scripts/check-ai-diff-audit.mjs` existiert mit purem Export `auditStagedDiff({ changes, diff, envelope })`. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.2 `package.json` enthaelt `check:ai-diff-audit`. (abgeschlossen: 2026-05-26; evidence: npm run check:ai-diff-audit -- --decision=D3 --gate="User approved V138 138.1/138.2 D3 slice" --generated-by="npm run graph:build" --not-checked="semantic test quality; preflight integration; D2 commit enforcement; CI/pre-commit hard wiring" --residual-risk="false positives may surface in later generated/governance slices" -> PASS staged=8 warnings=0)
- [x] DoD.3 `validateAgentEnvelope()` integriert das Audit und reicht `Generated-by:` sowie `Canonical-source:` durch. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-governance.contract.test.mjs -> PASS)
- [x] DoD.4 D2-Commits ohne `Not-checked:` failen. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-governance.contract.test.mjs -> PASS)
- [x] DoD.5 Generated-Artefakte unterscheiden `runtime-code`, `generator-code/tests` und reine Artefakt-Commits. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.6 Shadow-Truth-Heuristik eskaliert nur bei starker Autoritaetswirkung und erlaubtem Pfadabgleich. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.7 Gate-Bypass-Muster in Schutzflaechen erzwingen mindestens D3. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.8 Test-Skip-/Only-Spuren failen; weichere Testqualitaetsmuster bleiben Warnungen. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.9 Contracttests decken die geplanten sechs Kernfaelle ab. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] DoD.10 Abschluss-Evidence nennt gelaufene Gates, bewusst nicht gepruefte Semantik und verbleibende Warn-Risiken. (abgeschlossen: 2026-05-27; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS; npm run check:ai-diff-audit -> PASS; npm run plan:check -> PASS; npm run gates:pre-commit -> PASS; Not-checked: keine semantische Bewertung guter Tests, kein Scope-Validator-Import, keine CI-/Pre-Commit-Hardverdrahtung ausserhalb Agent-Preflight; Restrisiko: weichere Testqualitaetswarnungen bleiben heuristisch, Scope-Validator-Folge bleibt separater D3/D4-Slice)
...
- [x] 138.1.1 Datei-Klassen fuer Runtime-Code, Generator-Code, Generated-Artefakte, Governance, Source-of-Truth und Tests konkret in Pattern-Listen uebersetzen. (abgeschlossen: 2026-05-26; evidence: scripts/check-ai-diff-audit.mjs -> FILE_CLASS_RULES)
- [x] 138.1.2 Envelope-Felder `Generated-by:` und `Canonical-source:` fuer Preflight/Commit-Message-Parsing festlegen. (abgeschlossen: 2026-05-26; evidence: scripts/check-ai-diff-audit.mjs -> normalizeEnvelope)
- [x] 138.1.3 Testmatrix fuer die sechs Kernfaelle fixieren: runtime+generated, generator+generated mit `Generated-by`, Shadow-Truth, Gate-Bypass, `test.only`, D2 ohne `Not-checked`. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
...
- [x] 138.2.1 `scripts/check-ai-diff-audit.mjs` mit purem `auditStagedDiff()` und CLI anlegen. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] 138.2.2 `tests/agent-diff-audit.contract.test.mjs` fuer die sechs Kernfaelle anlegen. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] 138.2.3 `package.json` um `check:ai-diff-audit` ergaenzen. (abgeschlossen: 2026-05-26; evidence: npm run check:ai-diff-audit -- --decision=D3 --gate="User approved V138 138.1/138.2 D3 slice" --generated-by="npm run graph:build" --not-checked="semantic test quality; preflight integration; D2 commit enforcement; CI/pre-commit hard wiring" --residual-risk="false positives may surface in later generated/governance slices" -> PASS staged=8 warnings=0)
...
- [x] 138.3.1 `agent-preflight.mjs` ruft `auditStagedDiff()` mit staged changes, diff und Envelope auf. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-governance.contract.test.mjs -> PASS)
- [x] 138.3.2 Findings werden in bestehende `violations`/`warnings` eingeordnet. (abgeschlossen: 2026-05-26; evidence: tests/agent-governance.contract.test.mjs -> ai-diff-gate-bypass-requires-d3)
- [x] 138.3.3 `check-agent-commit-message.mjs` liest und reicht `Generated-by:` sowie `Canonical-source:` weiter. (abgeschlossen: 2026-05-26; evidence: tests/agent-governance.contract.test.mjs -> forwards generated and canonical source fields)
...
- [x] 138.4.1 `Not-checked:` ab `Decision: D2` hard required machen. (abgeschlossen: 2026-05-26; evidence: node --test tests/agent-governance.contract.test.mjs -> PASS)
- [x] 138.4.2 `Residual-risk:` fuer D2 als Warnung oder optionales Feld belassen; D3/D4 bleiben hard required. (abgeschlossen: 2026-05-26; evidence: tests/agent-governance.contract.test.mjs -> D3 residual risk and not checked fields)
- [x] 138.4.3 Commit-Message-Hinweise und Tests an neue Anforderungen anpassen. (abgeschlossen: 2026-05-26; evidence: scripts/check-agent-commit-message.mjs example fields; node --test tests/agent-governance.contract.test.mjs -> PASS)
...
- [x] 138.5.1 Audit gegen typische Graph-/Plan-/Generated-Slices trocken pruefen. (abgeschlossen: 2026-05-26; evidence: auditStagedDiff dry-run matrix via inline Node fuer reale V138-Commits 4e93b463/3cd12af8/30d18bd1 plus synthetische generated-only/Plan-/Shadow-Truth-Faelle -> PASS; erlaubte Faelle ohne Warnungen, Shadow-Truth-Negativkontrolle mit erwarteter violation)
- [x] 138.5.2 False-Positive-Liste dokumentieren und nur Pattern korrigieren, keine Semantik hinzufuegen. (abgeschlossen: 2026-05-26; evidence: dry-run matrix -> keine False Positives in erlaubten Graph-/Plan-/Generated-Slices; keine Pattern-Aenderung noetig)
- [x] 138.5.3 Scope-Validator-Import als separaten Folge-Slice entscheiden: pure function extrahieren, CLI als Wrapper behalten, Phase-Pflicht bei aktiven Locks pruefen. (abgeschlossen: 2026-05-26; evidence: read-only inspection `.agents/scripts/scope-validator.js` -> CLI-first mit `process.exit`, staged Git-Zugriff und duplizierter Glob-/Lock-Logik; Import/Refactor bleibt separater D3/D4-Folge-Slice)

Evidence-Notiz: 138.5 hat keine produktiven Patterns geaendert. `Not-checked:` keine semantische Testqualitaet, keine CI-/Pre-Commit-Hardverdrahtung, kein Scope-Validator-Import, kein Master-/Plan-Index-Sync.
...
- [x] 138.99.1 `node --test tests/agent-diff-audit.contract.test.mjs` ist gruen. (abgeschlossen: 2026-05-27; evidence: node --test tests/agent-diff-audit.contract.test.mjs -> PASS)
- [x] 138.99.2 `npm run check:ai-diff-audit` ist fuer den staged Abschlussdiff gruen oder meldet erwartete Warnungen. (abgeschlossen: 2026-05-27; evidence: npm run check:ai-diff-audit -- --decision=D3 --gate="User approved V138 138.99 closure" --generated-by="npm run plan:index:build; npm run graph:build" --canonical-source="docs/Umsetzungsplan.md; docs/plaene/aktiv/V138.md" --not-checked="semantic test quality; scope-validator import; CI/pre-commit hard wiring outside agent-preflight" --residual-risk="soft test-quality warnings remain heuristic; scope-validator import remains separate D3/D4 follow-up" -> PASS, INFO generated-artifact-only)
- [x] 138.99.3 `npm run plan:check` und `npm run gates:pre-commit` sind gruen. (abgeschlossen: 2026-05-27; evidence: npm run plan:check -> PASS; npm run gates:pre-commit -> PASS)
- [x] 138.99.4 Abschluss-Evidence nennt `Not-checked:` ehrlich: keine semantische Bewertung guter Tests, kein Scope-Validator-Import, keine CI-/Pre-Commit-Hardverdrahtung ausserhalb Agent-Preflight. (abgeschlossen: 2026-05-27; evidence: Abschluss-Snapshot in docs/plaene/CHANGELOG.md; Not-checked explizit benannt)

Abschluss-Evidence: V138 ist als Agent-Governance-Gate geschlossen. Das Diff-Audit bleibt deterministisch und staged-diff-basiert, haengt blockierend am bestehenden Agent-Preflight/Commit-Envelope und erweitert den schnellen Pre-Commit-Hook nicht direkt. `npm run gates:pre-commit` meldete beim Abschluss nur die bekannte nicht-blockierende V76-Evidence-Warnung aus `plan:evidence-claims`.
