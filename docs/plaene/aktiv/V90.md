...
Stand: 2026-05-18
Status: geplant; Audit-Baseline aktualisiert, separater Fix-Gate offen
Owner: frei
Risiko: hoch
...
- [ ] 90.2.3 Nachgezogene non-force Audit-Fix-Kandidaten separat entscheiden und nur mit eigenem Gate-Scope anwenden (`fast-uri` im Root-Tooling, `ip-address` im Electron-Tree).
