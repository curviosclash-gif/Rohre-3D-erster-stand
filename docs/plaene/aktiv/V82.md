...
## Leitplanke aus V91 (Architektur-Ratchet, 2026-04-15)

Hinweis 2026-04-15 (Quelle: `V91 91.5.1`, Referenz `docs/referenz/ai_architecture_context.md` Abschnitt 4.5.6): Folgearbeit in V82 nutzt fuer neue Runtime-, Persistenz- und HUD-Pfade den Architektur-Startcheck:
