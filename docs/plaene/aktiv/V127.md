...
scope_files:
  ...
  - start_repo_map.bat
  - start-plan-map.ps1
  - docs/plaene/aktiv/V127.md
scope_overlap_allowed_with:
  - V132
  - V144
scope_reference_files:
  - docs/plaene/neu/Feature_Repo_Map_Wissensgraph_Verankerung_V127.md
verification:
  - node --test tests/repo-map-export.contract.test.mjs
...
Block-ID: `V127`.
Kanonische Detaildatei: `docs/plaene/aktiv/V127.md`.
Zweckklasse: `plan`.
