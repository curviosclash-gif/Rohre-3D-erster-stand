...
blocked_by: []
scope_files:
  - src/core/config/maps/presets/parcours_pack_v130.js
  ...
  - tests/parcours-map-pack.contract.test.mjs
  - tests/parcours-map-pack-start.spec.js
  - docs/plaene/aktiv/V130.md
  - docs/plaene/CHANGELOG.md
verification:
  - node --test tests/parcours-map-pack.contract.test.mjs
  - npm run parcours:check -- --strict
  - node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000
  - npm run plan:check
  - npm run docs:sync
  - npm run docs:check
updated_at: 2026-05-21
source_history:
  - docs/plaene/alt/Feature_Parcours_Map_Pack_V130.md
---

# Feature: Kreatives Parcours Map Pack und Arcade-Routenvarianz (V130)

Status: Aktiver Block im Master-Index; Umsetzung und Abschluss-Gate sind abgeschlossen.
Ziel-Masterplan: `docs/Umsetzungsplan.md`.
Block-ID: `V130`.
Kanonische Detaildatei: `docs/plaene/aktiv/V130.md`.
Zweckklasse: `plan`.
...
- [x] DoD.1 Mindestens sechs neue Parcours-Presets sind im Desktop-Runtime-Katalog vorhanden und haben stabile Map-Keys, Namen, `parcours.enabled`, `routeId`, Regeln, Checkpoints, Finish, Player-Spawn, Bot-Spawns und Item-Anchor. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] DoD.2 Jede MVP-Map hat eine eigene Skill-Rolle; reine Varianten derselben Geometrie zaehlen nicht als erledigte Map-Varianz. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Map-Pack-Schnitt -> `commit 309ef8a9`)
- [x] DoD.3 Jede neue Route ist per Contract-Smoke validiert: acyclische Checkpoint-Reihenfolge, gueltige Branch-Merges, keine leeren Checkpoint-Listen, Finish vorhanden, Radius-/Segmentwerte plausibel. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] DoD.4 Ghost-/Leaderboard-Vertraege bleiben stabil: Jede Route nutzt eindeutige `routeId`, und Ghost-Selbstduell kann pro Route unterscheiden. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] DoD.5 Arcade-Sektorpool wird bewusst erweitert, ohne Langrouten frueh oder zu haeufig zu ziehen. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] DoD.6 Browser-Demo-Surface bleibt unveraendert oder eine Aenderung ist explizit user-gated dokumentiert. (abgeschlossen: 2026-05-20; evidence: `git show --name-only 309ef8a9` -> kein Demo-Allowlist-Diff)
- [x] DoD.7 Mindestens ein Playability-Signal prueft neue Maps auf Startbarkeit und grobe Finishbarkeit; Langrouten duerfen bei Flakiness nicht still als fertig gelten. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] DoD.8 Dokumentation nennt fuer jede Map Zielzeit, Skill-Rolle, Risiken und Tuning-Hypothese. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Detailentwuerfe -> `commit 309ef8a9`)
...
- [x] 130.1.1 Bestehende Parcours-Presets inventarisieren: Map-Key, Route-ID, Checkpoint-Anzahl, Branches, Zielzeit, Reset-Regeln, Ghost-Policy. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Ausgangslage -> `commit 309ef8a9`)
- [x] 130.1.2 MVP-Auswahl bestaetigen: `micro_maw`, `mirror_docks`, `glass_serpent`, `storm_switchyard`, `wind_cathedral`, `chrono_spillway`. (abgeschlossen: 2026-05-20; evidence: `src/core/config/maps/presets/parcours_pack_v130.js` -> `commit 309ef8a9`)
- [x] 130.1.3 Arcade-Pool-Regel festlegen: kurze Maps frueh, mittlere Maps normal, lange Maps spaeter oder expert-only. (abgeschlossen: 2026-05-20; evidence: `tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.1.4 Demo-Grenze dokumentieren: keine Browser-Demo-Erweiterung ohne explizite Freigabe. (abgeschlossen: 2026-05-20; evidence: `git show --name-only 309ef8a9` -> kein Demo-Allowlist-Diff)
...
- [x] 130.2.1 `tests/parcours-map-pack.contract.test.mjs` planen oder anlegen: prueft neue Keys im Catalog, `buildRouteFromParcours`, Branch-Merges, Finish und Route-IDs. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.2.2 Plausibilitaetsregeln definieren: minimale/maximale Checkpoint-Abstaende, Radius-Untergrenzen, keine identischen Spawnpunkte, keine leeren Bot-Spawns. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.2.3 Ghost-/Leaderboard-Probe vorbereiten: Jede neue Route erzeugt eindeutigen Keyspace fuer lokale Ghosts. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.2.4 Falls vorhandenes `npm run parcours:check -- --strict` genutzt wird, neue Maps dort explizit aufnehmen oder dokumentieren, warum targeted Contract reicht. (abgeschlossen: 2026-05-20; evidence: `npm run parcours:check -- --strict` -> PASS)
...
- [x] 130.3.1 `micro_maw` implementieren: kurze Tutorialroute, kein Portal-Pflichtpfad, geringe Penalty, sicherer Finish. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] 130.3.2 `mirror_docks` implementieren: Branch-Merge sauber mit `nextIds`, gespiegelte Linien und faire Item-Verteilung. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] 130.3.3 `glass_serpent` implementieren: S-Kurve, Tube-Shortcut, konservative Boost-Impulse, Recovery-Portal. (abgeschlossen: 2026-05-20; evidence: `npm run parcours:check -- --strict` -> PASS)
- [x] 130.3.4 Erste Welle in Catalog/Base einhaengen, aber Arcade-Pool nur konservativ erweitern. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
...
- [x] 130.4.1 `storm_switchyard` implementieren: Weichen-Branch mit High/Low-Linie, klare Merge-Logik, Recovery-Portale. (abgeschlossen: 2026-05-20; evidence: `npm run parcours:check -- --strict` -> PASS)
- [x] 130.4.2 `wind_cathedral` implementieren: Slingshot-Kette, Hoehenlesbarkeit, sichere Foam-Rettungsfelder. (abgeschlossen: 2026-05-20; evidence: `npm run parcours:check -- --strict` -> PASS)
- [x] 130.4.3 `chrono_spillway` implementieren: lange Segmentroute, Risk-Sluice-Branch, Ghost-/Split-Fokus. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] 130.4.4 Langrouten im Arcade-Pool erst spaet oder expert-nah aktivieren. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
...
- [x] 130.5.1 Map-Auswahl und Mode-Eligibility pruefen: Arcade darf neue Parcours-Maps sehen, normale Modi nur wenn bestehende Regeln es erlauben. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.5.2 Preview-Labels/Badges nur dann anfassen, wenn V113-Scope frei ist; sonst Fallback-Preview akzeptieren. (abgeschlossen: 2026-05-20; evidence: `git show --name-only 309ef8a9` -> kein `src/ui/menu/MenuPreviewCatalog.js`-Diff)
- [x] 130.5.3 Browser-Demo-Allowlist unveraendert lassen oder mit User-Gate bewusst erweitern. (abgeschlossen: 2026-05-20; evidence: `git show --name-only 309ef8a9` -> kein Demo-Allowlist-Diff)
- [x] 130.5.4 Favoriten-/Recent-/Random-Map-Pfade auf nicht kuratierte Demo-Auswahl pruefen. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
...
- [x] 130.6.1 Contract-Gates fuer alle neuen Routen ausfuehren. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.6.2 Mindestens `micro_maw`, `mirror_docks` und eine Langroute per Playwright/desktop-start smoke pruefen. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] 130.6.3 Schwierigkeit staffeln: Tutorial, Flow, Branch, Vertikal, Endurance duerfen nicht alle gleich hart sein. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` MVP-Pack -> `commit 309ef8a9`)
- [x] 130.6.4 Ghost-/Split-Verhalten exemplarisch pruefen: Route-ID, Finish-Event, Segment-Splits und Penalty bleiben plausibel. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
...
- [x] 130.7.1 Pro shipping Map eine kompakte Designnotiz pflegen: Skill-Rolle, Zielzeit, Risiken, Tuning-Hypothese. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Detailentwuerfe -> `commit 309ef8a9`)
- [x] 130.7.2 Backlog-Ideen klassifizieren: sofort umsetzbar, GLB/Asset-abhaengig, Preview/UI-abhaengig, Expert-only. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Backlog-Ideen -> `commit 309ef8a9`)
- [x] 130.7.3 Handoff an V106/V128/V129 dokumentieren, falls GLB- oder Asset-Setdressing spaeter relevant wird. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Abhaengigkeiten -> `commit 309ef8a9`)
- [x] 130.7.4 Bekannte Limitierungen dokumentieren: keine beweglichen Hazards, keine echten Loops, keine Demo-Erweiterung. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Nicht-Ziel -> `commit 309ef8a9`)
...
- [x] 130.99.1 `npm run plan:check`, `npm run docs:sync` und `npm run docs:check` sind gruen. (abgeschlossen: 2026-05-20; evidence: `commit 309ef8a9` -> PASS)
- [x] 130.99.2 Map-Pack-Contract-Checks sind gruen oder ein Blocker ist in `docs/Fehlerberichte/` dokumentiert. (abgeschlossen: 2026-05-20; evidence: `node --test tests/parcours-map-pack.contract.test.mjs` -> PASS)
- [x] 130.99.3 Playability-Smoke ist fuer die vereinbarte Auswahl gruen. (abgeschlossen: 2026-05-20; evidence: `node scripts/run-playwright-smoke.mjs tests/parcours-map-pack-start.spec.js --timeout=180000` -> PASS)
- [x] 130.99.4 `scope-collisions` nennt keine ungeklaerte Kollision mit V113/V106/V128/V129 fuer die tatsaechlich geaenderten Dateien. (abgeschlossen: 2026-05-20; evidence: `node scripts/query-knowledge-graph.mjs scope-collisions --json` -> PASS)
- [x] 130.99.5 Abschlussnotiz nennt, welche Backlog-Maps bewusst nicht gebaut wurden. (abgeschlossen: 2026-05-20; evidence: `docs/plaene/aktiv/V130.md` Bewusst nicht gebaut -> `commit 309ef8a9`)

## Umsetzungsevidence 2026-05-20

Status: D2-Code-/Test-Scope aus dem Draft umgesetzt; D3-Intake am 2026-05-21 in `docs/Umsetzungsplan.md` und `docs/plaene/aktiv/V130.md` kanonisiert.
...
Der urspruengliche Draft war `D2` und liegt nach Intake unter `docs/plaene/alt/Feature_Parcours_Map_Pack_V130.md`.

Umgesetzte und begrenzte Flaechen:
...
| Masterplan-/Aktivplan-Intake | D3 | explizite User-Anforderung 2026-05-21 |

## Validierungsplan fuer den aktiven Block
