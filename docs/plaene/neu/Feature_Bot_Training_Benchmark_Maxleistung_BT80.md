...
- [x] 80.3.1 Einen Engpass-Scan fuer Trainer-Server, Bridge, Serialization, Replay, Checkpoint-Export, Eval-Lane, Report-IO und Preview-/Publish-Pfade aufbauen. (abgeschlossen: 2026-04-02; evidence: preview/publish/report-io diagnostics + hard artifact audit -> `scripts/bot-validation-runner.mjs`, `scripts/training-bot-validation-lane.mjs`, `scripts/training-gate.mjs`, `src/state/training/TrainingBenchmarkFailures.js`)
