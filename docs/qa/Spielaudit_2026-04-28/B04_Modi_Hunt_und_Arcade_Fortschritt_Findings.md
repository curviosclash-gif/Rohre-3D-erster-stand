...
- Seed-Override in `ArcadeRunRuntime` ist in V112 erledigt; gezielte Daily-/Challenge-Run-Evidence liegt mit `T20am1` vor.
...
- Arcade-Strategy-Lifecycle-Reset fuer Sudden Death, Modifier und Slot-Boni ist in V112 erledigt; Evidence liegt mit `T20am2` vor.
