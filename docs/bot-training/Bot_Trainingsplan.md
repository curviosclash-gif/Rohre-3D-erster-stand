...
- `BT93Y.5` ist als `retrain-lineage-ready-bt93r-reentry-ready` abgeschlossen; das Reentry-Paket oeffnet erst nach gruenem `BT93Y.99` einen neuen `BT93R-Reentry`, nicht `BT93S/O/X/P/94A`.
...
| BT93Y | BT93R.99 `model-artifact-missing` + X0-Preflight-Report `dqn-loader-fix-required` + User-Intake 2026-04-30 | hard | ja | Lineage-Recovery/Retraining, Ersatzvergleichspolitik und neuer BT93R-Reentry; aktueller naechster Scope ist 93Y.99 |
...
| Bot-Codex | BT93Y | 2026-04-30 | active | 93Y.5 abgeschlossen als `retrain-lineage-ready-bt93r-reentry-ready`; naechster Fix-Planungs-GO-Scope ist 93Y.99 |
...
| BT93Y | PPO Lineage-Recovery/Retraining und Ersatzvergleich | active | P0 | BT93R.99 `model-artifact-missing` + X0-Preflight-Report `dqn-loader-fix-required` | 93Y.99 | `docs/plaene/neu/BT93Y_PPO_Lineage_Recovery_Retraining_ReplacementPolicy_Intake_2026-04-30.md` |
...
- `/fix-planung` ist nach `93Y.5=retrain-lineage-ready-bt93r-reentry-ready` nur fuer `93Y.99` freigegeben; `BT93S/O/X/P/94A` bleiben No-Go.
...
| 26 | `BT93Y.5 BT93R-Reentry-Paket` abgeschlossen; naechster Claim `93Y.99` Abschluss-Gate. | `BT93Y.4=replacement-policy-approved`; Reentry-Paket darf noch keinen echten R-Claim starten. | `bt93r_reentry_gate_report.json` meldet `retrain-lineage-ready-bt93r-reentry-ready`; `/fix-planung` GO nur fuer `93Y.99`, kein `BT93S/O/X/P/94A`. |
...
- Kein `BT93S`-Start und keine R/S/O/P-Fixplanung ausser dem aktuellen BT93Y-Subpfad; nach `93Y.5=retrain-lineage-ready-bt93r-reentry-ready` ist nur `93Y.99` erlaubt, solange `BT93Y.99` nicht `bt93rReentryAllowed=true` plus gruene BT93Y-Resultklasse schreibt und ein neuer `BT93R-Reentry.99` nicht in R-Allowlist endet.
