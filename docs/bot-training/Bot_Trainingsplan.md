...
| BT93S2R4 | 93S2R3.2=`replay-determinism-required` + User-Intake 2026-05-01 | hard | ja | `93S2R4.3` abgeschlossen; naechster claimbarer Scope ist nur `93S2R4.4`; oeffnet maximal spaeter `93S2R3.3-Reentry`, kein Recheck und kein `93S2.4` |
...
| Bot-Codex | BT93S2R4 | 2026-05-01 | active | `93S2R4.3` abgeschlossen; naechster Scope: `93S2R4.4` Predicate-/Window-Recheck auf stabiler Replay-Basis |
...
| BT93S2R4 | Replay-/StartState-Determinism Repair nach rotem S2R3.2 | active | P0 | 93S2R3.2=`replay-determinism-required`, `opensNext=[]` + User-Intake 2026-05-01 | 93S2R4.4 | `docs/plaene/neu/BT93S2R4_Replay_StartState_Determinism_Repair_Intake_2026-05-01.md` |
...
| 35 | `93S2R4.4 Predicate-/Window-Recheck auf stabiler Replay-Basis` claimen. | `deterministic_reset_repair_report.json` meldet gruenes Repeat-Gate; Downstream bleibt bis `BT93S2R4.99=replay-startstate-green` geschlossen. | Predicate-Ausdruck, Predicate-Funktion, Minimum-Window und `measurementInvalidBeforeAction` auf allen 103 Rows neu zaehlen; Ziel `predicateFailureCount=0`, `minimumWindowFailureCount=0`, `measurementInvalidBeforeActionCount=0`, `warmupTerminalBeforeActionCount=0`. |
...
- Kein BT93T-/BT93U-/BT93W-/BT93O-/BT93P-/BT94A-Start aus `BT93S.99=matrix-redesign-required`, altem `BT93S2.3=measurement-invalid`, frischem `BT93S2.3-Recheck=measurement-invalid`, `BT93S2R2.99=measurement-invalid` oder rotem `BT93S2R3`. Stand 2026-05-01 endet `93S2R3.2` rot als `replay-determinism-required` mit `opensNext=[]`; `93S2R4.3` ist abgeschlossen und der naechste erlaubte Scope ist nur `93S2R4.4`. `93S2R3.3/4/99`, `BT93S2.3-Recheck` und `93S2.4` starten erst nach `BT93S2R4.99=replay-startstate-green`. `BT93T` oeffnet nur bei frischem `BT93S2.99=observation-telemetry-required`, `BT93U` nur bei frischem `BT93S2.99=action-selection-green`.
