...
Stand: 2026-05-28. Aktiver Lock: `-`; Startanker: `V120 120.99 abgeschlossen`; kein offener P1-Schritt; naechster empfohlener AI/Graph-Folgepfad ist `V137 137.4` fuer den Curvios-/CodeGraph-Vergleich oder `V121 121.1` nach User-Priorisierung.
...
| V137 | CodeGraph Read-only Installationsspike fuer Graph-RAG | planned | P2 | frei | V107.99,V110.99,V111.99,V120.1 | 137.4 | `docs/plaene/aktiv/V137.md` |
...
| - | V137 | - | frei | 137.3 abgeschlossen 2026-05-28; lokaler CodeGraph-Init und Sync auf 1057 Files/18321 Nodes; naechster Schritt 137.4 Vergleich; MCP/Agent-Config bleiben eigene D4-Gates |
| - | V121 | - | frei | Geplant |
...
8. `V137` (CodeGraph Read-only Installationsspike fuer Graph-RAG) steht nach lokalem CodeGraph-Init und Sync auf `137.4`; MCP und Agent-Config bleiben separate D4-Gates; Curvios-Graph bleibt Wahrheit, CodeGraph hoechstens Candidate Provider.
