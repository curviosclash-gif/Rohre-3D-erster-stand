...
Naechste offene Subphase: `95.4` (siehe `docs/plaene/aktiv/V95.md`). Phase 95.3 abgeschlossen 2026-04-18. Aktuelle Intake-Drafts: `docs/plaene/neu/`.
...
| V95 | Settings Studio fuer Menu-Defaults | planned | P2 | frei | V77.99,V92.99 | 95.4 | `docs/plaene/aktiv/V95.md` |
