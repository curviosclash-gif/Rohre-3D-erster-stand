...
| Agent-Codex | V85 | 2026-04-12 | active | `85.4.1` abgeschlossen; als naechstes `85.4.2` Fehler-, Warn- und Migrationsmeldungen fuer inkompatible Artefakte bewusst gestalten |
...
3. `V85` weiter durch `85.4.2` ziehen, damit der Persistence-/Content-Vertragsrahmen nach V89 ohne Verifikationsdrift aufgebaut wird.
