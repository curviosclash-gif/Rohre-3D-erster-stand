...
| V85 | Persistence-, Content-Contracts und Schema-Migrationen | active | P2 | Agent-Codex | V83.99 | 85.2 | `docs/plaene/aktiv/V85.md` |
...
| Agent-Codex | V85 | 2026-04-12 | active | `85.1.2` abgeschlossen; als naechstes `85.2.1` den kleinen Migrationsrahmen fuer Load-/Upgrade-/Fallback-/Reject-Pfade definieren |
...
3. `V85` weiter durch `85.2.1` ziehen, damit der Persistence-/Content-Vertragsrahmen nach V89 ohne Verifikationsdrift aufgebaut wird.
