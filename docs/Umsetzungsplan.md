...
Stand: 2026-05-17. Aktiver Lock: `codex` auf `V116 116.6`; Startanker: `V116 Abschluss/Park-Slice` -> `V90 Audit-Baseline` -> `V126 126.1`.
...
| V116 | Repo-Kontext-Reduktion und Deep-Cleanup-Sanierung | active | P1 | frei | V109.99,V117.99,V115.99 | 116.6 | `docs/plaene/aktiv/V116.md` |
...
| codex | V116 | 2026-05-15 | active | 116.6 Gate-Matrix |
| - | V119 | - | frei | Geplant |
| - | V123 | - | frei | Geplant |
| - | V125 | - | frei | Geplant |
| - | V126 | - | frei | Geplant |
