...
Naechste offene Subphase: V82 `82.6` (Checkpoint-Zustandsfarben und Ring-Animation). V82 Phase 82.5 abgeschlossen 2026-04-18. Aktuelle Intake-Drafts: `docs/plaene/neu/`.
...
| V82 | Arcade-Parcours Progression XP Flugzeug-Tuning | planned | P2 | frei | V72.99,V74.99 | 82.6 | `docs/plaene/aktiv/V82.md` |
