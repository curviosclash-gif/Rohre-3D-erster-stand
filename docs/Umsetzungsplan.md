...
Stand: 2026-05-27. Aktiver Lock: `codex V120 120.5`; Startanker: `V138 138.99 abgeschlossen`; naechster empfohlener P1-Schritt ist `V120 120.5`.
...
| V120 | Graph-RAG mit lokalem Context-Adapter | active | P1 | codex | V107.99,V110.99,V111.99 | 120.5 | `docs/plaene/aktiv/V120.md` |
...
| codex | V120 | 2026-05-27 | active | 120.5 naechster Slice; 120.4 lokale LLM-Auswahl und Fallback-Smoke abgeschlossen |
...
7. `V120` (Graph-RAG mit lokalem Context-Adapter) ist aktiv; `120.4` hat lokale LLM-Auswahl, Runtime-Profile und Fallback-Smoke geliefert, naechster P1-Schritt ist `120.5` lokaler Context-Adapter.
