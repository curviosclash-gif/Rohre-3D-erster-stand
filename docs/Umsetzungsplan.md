...
Naechste offene Subphase: V82 `82.7` (Minimap und Routenvorschau). V82 Phase 82.6 abgeschlossen 2026-04-19. Aktuelle Intake-Drafts: `docs/plaene/neu/`.
...
| V82 | Arcade-Parcours Progression XP Flugzeug-Tuning | planned | P2 | frei | V72.99,V74.99 | 82.7 | `docs/plaene/aktiv/V82.md` |
