...
| V88 | Testarchitektur und Verifikationsvertraege | planned | P2 | frei | V87.99 | 88.1 | `docs/plaene/aktiv/V88.md` |
...
| - | V88 | - | frei | Nach `V87.99` als naechsten Architektur-/Verifikationsblock fuer explizite Laufmodi, zentrale Readiness-Fixtures und entkoppelte Targeted-Suites starten |
