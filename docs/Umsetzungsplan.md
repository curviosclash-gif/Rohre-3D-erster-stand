...
Stand: 2026-05-27. Aktiver Lock: `codex V120 120.4`; Startanker: `V138 138.99 abgeschlossen`; naechster empfohlener P1-Schritt ist `V120 120.4`.
...
| V120 | Graph-RAG mit lokalem Context-Adapter | active | P1 | codex | V107.99,V110.99,V111.99 | 120.4 | `docs/plaene/aktiv/V120.md` |
...
| codex | V120 | 2026-05-27 | active | 120.4 naechster Slice; 120.3 Graph-RAG Retrieval-Pipeline abgeschlossen |
...
7. `V120` (Graph-RAG mit lokalem Context-Adapter) ist aktiv; `120.3` hat die Graph-First-Retrieval-Pipeline geliefert, naechster P1-Schritt ist `120.4` lokale LLM-Auswahl/Installation.
