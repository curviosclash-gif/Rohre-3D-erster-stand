...
Stand: 2026-03-31 (V60, V61, V65, V66, V67, V68, V69 und V70 abgeschlossen; V72 und V74 aufgenommen; V64 bleibt offen)
...
V60, V61, V66, V67, V68, V69 und V70 sind abgeschlossen. V72 und V74 sind als neue aktive Planbloecke aufgenommen; V64 bleibt weiterhin undefiniert.
...
| E | **V72** | Gameplay-Vertraege fuer Powerups, Portale und Gates; gut parallel zu Architekturarbeit, aber vor tiefer Bot-Semantik zu stabilisieren |
| F | **V74** | Runtime-Komposition, Lifecycle-Port-Schnitt und Config-/Entity-Entkopplung; parallel zu V72 moeglich, aber auf Shared-Core-Pfade achten |

Empfehlung: V72 und V74 als neue P1-Spuren vorbereiten; V64 bleibt separat bis zur Scope-Klaerung.
...
| V72 | Gameplay-Powerups, Portale und Gates - Vertragsklarheit und Sichtbarkeit | `docs/plaene/alt/Feature_Gameplay_Powerups_Portale_Gates_V72.md` | hoch | gross | P1 | Intake abgeschlossen; Claim fuer 72.1 Capability-Matrix und Portal-/Gate-Vertrag offen | Geplant |
| V74 | Architektur-Runtime-Entkopplung | `docs/plaene/alt/Feature_Architektur_Runtime_Entkopplung_V74.md` | sehr hoch | gross | P1 | Intake abgeschlossen; Claim fuer 74.1 Runtime-Bundle und Entkopplungsport offen | Geplant |
