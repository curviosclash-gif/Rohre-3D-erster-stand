...
start "Trainer Server" cmd /k "cd /d ""%ROOT%"" && node ""%ROOT%\dev\scripts\trainer-server.mjs"""
...
node "%ROOT%\dev\scripts\training-run.mjs" --bridge-mode bridge --bridge-url %BRIDGE_URL% --bridge-connect-timeout-ms 5000 --bridge-strict true --bridge-require-ready-message true --stamp %TRAIN_STAMP% %*
