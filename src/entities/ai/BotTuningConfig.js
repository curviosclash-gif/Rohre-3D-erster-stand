...
export const BOT_FALLBACK_DIFFICULTY_PROFILE = Object.freeze({
    ...
    boostChance: 0.004,
    survivalBias: 0.6,
    boostRiskCeiling: 0.42,
    projectileBoostRiskCeiling: 0.5,
    pursuitRiskCeiling: 0.42,
    pursuitSurvivalCeiling: 0.66,
    emergencyForwardRisk: 0.82,
    emergencyPressure: 0.9,
    emergencyBouncePressure: 2.0,
    collisionPressureRecoveryThreshold: 2.3,
    recoveryBoostRiskCeiling: 0.55,
});
