...
export function createGameUiRefs() {
    const ui = {
        ...
        quickStartEventPlaylistButton: document.getElementById('btn-quick-event-playlist'),
        ...
        developerTelemetryDashboard: document.getElementById('developer-telemetry-dashboard'),
